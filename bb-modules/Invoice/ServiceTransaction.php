...
class ServiceTransaction implements InjectionAwareInterface
{
    ...
    public function processTransaction($id)
    {
        ...
        file_put_contents('debug.log', json_encode('test 0', JSON_PRETTY_PRINT), FILE_APPEND);
        ...
        file_put_contents('debug.log', json_encode('test 1', JSON_PRETTY_PRINT), FILE_APPEND);
        ...
        file_put_contents('debug.log', json_encode('test 2', JSON_PRETTY_PRINT), FILE_APPEND);
        $ipn = json_decode($tx->ipn, 1);
        file_put_contents('debug.log', json_encode($tx, JSON_PRETTY_PRINT), FILE_APPEND);
        file_put_contents('debug.log', json_encode('test 3', JSON_PRETTY_PRINT), FILE_APPEND);
